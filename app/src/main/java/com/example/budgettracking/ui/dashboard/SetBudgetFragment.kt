...
import com.example.budgettracking.databinding.FragmentSetbudgetBinding
...
class SetBudgetFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val dashboardViewModel =
            ViewModelProvider(this).get(SetBudgetViewModel::class.java)

        _binding = FragmentSetbudgetBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textSetbudget
